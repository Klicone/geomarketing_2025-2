...
::: {style="text-align: justify;"}
La visualización también se llevo a cabo en el entorno RStudio, utilizando principalmente las librerías `ggplot2`, `sf`, `biscale` y `cowplot`.
